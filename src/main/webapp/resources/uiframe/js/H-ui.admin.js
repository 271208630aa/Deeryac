 ...
 */
function haveUIPath() {
    return baseurl + "/resources/uiframe";
}
...
function getskincookie() {
    ...
    $("#skin").attr("href", haveUIPath() + "/skin/" + v + "/skin.css");
}
...
$(function () {
    ...
    $("#Hui-skin .dropDown-menu a").click(function () {
        ...
        setCookie("Huiskin", v);
        var skinpath = haveUIPath() + "/skin/" + v + "/skin.css";
        $("#skin").attr("href", skinpath);
        $(window.frames.document).contents().find("#skin").attr("href", skinpath);
    });
});
